...
TODO INCLUIR UNA CAPTURA CUANDO ESTÉ LA WEB TRADUCIDA (ref fig:pagina\_monitorizacion)
...
Si todo ha funcionado correctamente se podrá acceder a la página principal del dashboard en la dirección web \url{http://192.168.0.220:3000}.

% TODO INSERTAR CAPTURA

TODO INSERTAR CAPTURAS PRINCIPAL, DASHBOARD, ABOUT
