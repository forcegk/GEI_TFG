...
\begin{wrapfigure}[8]{r}{0.125\textwidth}
  \centering
  \vspace*{-0.3cm}
...
Esto es posible debido a que virtualmente Clúpiter está conectado a un switch de 9 puertos, como se puede observar en la Figura \ref{fig:raspi_diagram_eth}: \nameref{fig:raspi_diagram_eth}. El esquema lógico de red para el caso en el que existe un host conectado al cluster, en la IP 192.168.0.1, haga de gateway o no (en el diagrama sí es el gateway), es el siguiente:
