...
\begin{enumerate}
    \item Explicar el funcionamiento del cluster, los supercomputadores paralelos, \acrshort{mpi}, y la importancia en el mundo real de los mismos, mediante vídeos pregrabados reproducibles en la página web.
