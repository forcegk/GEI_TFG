...
\begin{table}[H]
  ...
  \hline
  -- & \multicolumn{2}{c|}{IVA agregado\tablefootnote{El IVA se encuentra en una entrada separada, y se ha incluído en el coste total, pero conviene tener en cuenta que la Universidad no lo paga, por lo que el precio final del material es ligeramente menor.}}      & 146.08\\
  \hhline{|-|--|-|}
  \hhline{|-|--|-|}
  \hhline{|-|--|-|}
