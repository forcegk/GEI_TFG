...
\begin{figure}
    ...
    \resizebox{\linewidth}{!}{
        ...
        \begin{ganttchart}[
            ...
            \ganttgroup{Fase 6}{2021-6-18}{2021-9-12}\\
            % redacción de la memoria
            \ganttbar[name=s]{Tarea s}{2021-6-18}{2021-9-5}\\
            % maquetado y relacionados
            \ganttbar[name=t]{Tarea t}{2021-9-6}{2021-9-12}\\
            % grabación de los vídeos
            \ganttbar[name=u]{Tarea u}{2021-9-8}{2021-9-11}\\
            % traducción y puesta a punto del dashboard
            \ganttbar[name=v]{Tarea v}{2021-9-9}{2021-9-12}\\
