...
\newglossaryentry{backend}{
  name=backend,
  description={Parte del desarrollo web que se encarga del correcto funcionamiento de la lógica de una página web. Esta lógica por lo general no es visible para el usuario (por ejemplo la comunicación con el servidor, o el acceso a datos), por lo que se dice que está en la ``parte-de-atrás'' o back-end}
}
